...
class DiceTossModel:
    def __init__(self):
        ...
        self.transform = transforms.Compose([
            transforms.Resize((32, 32)),  # Přidáno pro konzistentní velikost
    ...
    def initialize_model(self):
        ...
        self.optimizer = None  # Bude nastaveno při tréninku

    def train(self, epochs, learning_rate, momentum, progress_callback=None):
        """Trénuje model a vrací historii loss"""
        if self.net is None:
            raise ValueError("Model není inicializován")
    ...
    def predict_image(self, image_path):
        """Predikuje třídu pro jeden obrázek"""
        if self.net is None:
            raise ValueError("Model není inicializován")
