from PyQt6.QtWidgets import (
    QWidget, QPushButton, QVBoxLayout, QHBoxLayout, QGroupBox, QLineEdit,
    QLabel, QSlider, QDoubleSpinBox, QSpinBox, QSizePolicy, QFileDialog,
...
class PlotWidget(QWidget):
    def __init__(self, title, parent=None):
        ...
        # Add a frame styled like a group box
        frame = QFrame()
        frame.setObjectName("StyledFrame")  # Assign an object name for custom styles
        frame.setStyleSheet("""
            QFrame#StyledFrame {
...
class ImageClassificationWidget(QWidget):
    def __init__(self, parent=None):
        ...
        #self.load_image_btn.clicked.connect(PytorchTab.load_image)     TLACITKO NEFUNGUJE HAHAHAHFAHKJDSFASKLFHJ
    ...
    def load_image(self):
        ...
        if file_path:
            ...
            if not pixmap.isNull():
                ...
                self.image_widget.image_display.setPixmap(scaled_pixmap)
